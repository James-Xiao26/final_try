...
// Kicks off Google OAuth. Supabase sends the user to Google, then back to /auth/callback?next=…
// which exchanges the code for a session cookie.
export default function SignInButton({ next = "/", className = "gbtn" }: { next?: string; className?: string }) {
...
function GoogleGlyph() {
  return (
    <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden="true">
      ...
      <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.1-4.1 5.6l6.2 5.2C40.9 36.5 44 30.8 44 24c0-1.3-.1-2.3-.4-3.5z" />
    </svg>
  );
}
